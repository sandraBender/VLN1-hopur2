...
# Template: app
# Command: /Users/sindrirafn/Qt/5.5/clang_64/bin/qmake -spec macx-clang CONFIG+=debug -o Makefile VLN1-hopur2.pro
#############################################################################
...
Makefile: VLN1-hopur2.pro ../Qt/5.5/clang_64/mkspecs/macx-clang/qmake.conf ../Qt/5.5/clang_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec macx-clang CONFIG+=debug -o Makefile VLN1-hopur2.pro
