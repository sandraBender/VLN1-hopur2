...
struct qt_meta_stringdata_AddComp_t {
    QByteArrayData data[4];
    char stringdata0[55];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_AddComp_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AddComp_t qt_meta_stringdata_AddComp = {
    {
QT_MOC_LITERAL(0, 0, 7), // "AddComp"
QT_MOC_LITERAL(1, 8, 23), // "on_button_close_clicked"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 21) // "on_button_add_clicked"

    },
    "AddComp\0on_button_close_clicked\0\0"
...
const QMetaObject AddComp::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AddComp.data,
      qt_meta_data_AddComp,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AddComp::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AddComp.stringdata0))
